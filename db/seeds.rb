...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  users = User.create([{ id: 1, name: 'Evgeny Esaulkov', password: 'abracadabra', limit: 20000, email: 'evg.esaulkov@gmail.com' }])
  ...
  categories = Category.create([
    { :id => 1, :name => 'Продукты' },
    { :id => 2, :name => 'Кафе/рестораны' },
    { :id => 3, :name => 'Перевод средств' },
    { :id => 4, :name => 'Бытовые товары' }
  ])
